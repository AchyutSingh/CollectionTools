...
public class TreeSetCollectionLogics {

	public static Map<String,Set<Object>> arrayNameAndListMap=new LinkedHashMap<String,Set<Object>>();
	public static Map<String,TreeSetModel> arrayNameAndModelMap=new LinkedHashMap<String,TreeSetModel>();
	Map<String,ArrayList> map=null;
	ArrayList<Object> temp=null;
	public Map<String,TreeSetModel> createArrayList(String treeSetName,String dataType) throws Exception{
		/*int size=0;
		...
		TreeSetModel treeSetCreateModel=new TreeSetModel();
		treeSetCreateModel.setTreeSetName(treeSetName);
	
		treeSetCreateModel.setTreeSetDataType(dataType);
		arrayNameAndModelMap.put(treeSetName, treeSetCreateModel);
		...
		arrayNameAndListMap.put(treeSetName, all);
